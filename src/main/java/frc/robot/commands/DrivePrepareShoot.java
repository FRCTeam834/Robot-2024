...
public class DrivePrepareShoot extends ParallelCommandGroup {
  ...
  public DrivePrepareShoot(Swerve driveTrain, Shooter shooter, PoseEstimator poseEstimator, DoubleSupplier vxSupplier, DoubleSupplier vySupplier, DoubleSupplier omegaSupplier) {
