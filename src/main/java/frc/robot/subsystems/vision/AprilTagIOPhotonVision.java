...
public class AprilTagIOPhotonVision implements AprilTagIO {
    ...
    static {
        ...
        // higher offset -> greater shooter angle
        shooterAngleOffsetTable.put(2.0, Units.degreesToRadians(5.0)); // 5.0
        shooterAngleOffsetTable.put(0.65, Units.degreesToRadians(5.0)); // 5.0
        shooterAngleOffsetTable.put(0.5, Units.degreesToRadians(3.0)); // 4.0
        shooterAngleOffsetTable.put(0.3, Units.degreesToRadians(1.5)); // 2.5
        shooterAngleOffsetTable.put(0.0, Units.degreesToRadians(1.5)); // 2.5
    }
