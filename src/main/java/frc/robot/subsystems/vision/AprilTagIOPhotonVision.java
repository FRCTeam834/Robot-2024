...
public class AprilTagIOPhotonVision implements AprilTagIO {
    ...
    static {
        ...
        shooterAngleOffsetTable.put(0.5, Units.degreesToRadians(4.0)); // 4.0
        shooterAngleOffsetTable.put(0.3, Units.degreesToRadians(3.0)); // 2.5
        shooterAngleOffsetTable.put(0.0, Units.degreesToRadians(3.0)); // 2.5
    }
